...
const Track = ({track, chooseTrack}) => {
  ...
  return (
    <div className="flex items-center justify-between space-x-[1rem] cursor-default hover:bg-white/10 
    py-2 px-4 rounded-lg group transition ease-out">
        <div className="flex items-center">
        <img src={track.albumUrl} alt="" track={track} chooseTrack={chooseTrack}
        ...
        <div className="flex items-center rounded-full border-2 border-[#262626] w-[85px] h-10 
