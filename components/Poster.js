...
export const Poster = ({track, chooseTrack}) => {
  ...
  return (
    <div className='w-[200px] h-[300px] rounded-[50px] overflow-hidden 
    ...
    className='h-full w-full absolute object-cover inset-0 rounded=[50px] opacity-80 group-hover:opacity-100' />
    <div className='absolute bottom-10 inset-x-0 ml-4 flex items-center space-x-3.5'>
        ...
        <h4 className='font-extrabold truncate w-32'>{track.title}</h4>
        <h4>{track.artist}</h4>
        </div>
    </div>
    </div>
